...
paths = "/home/workspace/CarND-Behavioral-Cloning-P3/data/"
os.chdir(r"/home/workspace/CarND-Behavioral-Cloning-P3/data/")

## Link to my collected  data
path_mydata = "/root/Desktop/data/"
...
file2 = os.path.join(path_mydata, 'driving_log.csv')
    ...
    while 1: # Loop forever so the generator never terminates
        ...
        for offset in range(0, num_samples, batch_size):
            ...
            for batch_sample in batch_samples:
                center_name = '/home/workspace/CarND/CarND-Behavioral-Cloning-P3/data/IMG/'+batch_sample[0].split('/')[-1]
                center_image = cv2.imread(center_name)
                center_image = cv2.cvtColor(center_image, cv2.COLOR_BGR2RGB)
                left_name = '/home/workspace/CarND/CarND-Behavioral-Cloning-P3/data/IMG/'+batch_sample[1].split('/')[-1]
                left_image = cv2.imread(left_name)
                left_image = cv2.cvtColor(left_image, cv2.COLOR_BGR2RGB)
                right_name = '/home/workspace/CarND-Behavioral-Cloning-P3/data/IMG/'+batch_sample[2].split('/')[-1]
...
def valid_generator(samples, batch_size=batch_size):
        ...
        while 1:  # Loop forever so the generator never terminates
            ...
            for offset in range(0, num_samples, batch_size):
                ...
                for batch_sample in batch_samples:
                    center_name = '/home/workspace/CarND-Behavioral-Cloning-P3/data/IMG/' + batch_sample[0].split('/')[-1]
                    center_image = cv2.imread(center_name)
                    center_image = cv2.cvtColor(center_image, cv2.COLOR_BGR2RGB)
